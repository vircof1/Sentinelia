...
//var_dump($usuario -> getUsuarioVerificado());
global $usuario;
...
$contenido = '
        ...
        <li class="nav-item"><a class="nav-link" href="index.php">
            ...
            </svg>Dashboard<span class="badge badge-sm bg-info ms-auto"></span></a>
        </li>
...
if  ( $usuario -> getUsuarioVerificado() ) {
	if( $usuario -> puedeAuditarCualquierCosa() ){
		 $contenido .='
		 <li class="nav-item"><a class="nav-link" href="?pagina=VisorEventos">
            <svg class="nav-icon">
              <use xlink:href="Template/vendors/@coreui/icons/svg/free.svg#cil-align-left"></use>
            </svg>Visor de eventos<span class="badge badge-sm bg-info ms-auto"></span></a>
        </li>
        ';
	}
		...
		$contenido .= '
			<li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
			  ...
			  <ul class="nav-group-items">
				<li class="nav-item"><a class="nav-link" href="?pagina=MonitoresPING"><span class="nav-icon"></span> Ping </a></li>
				<li class="nav-item"><a class="nav-link" href="?pagina=MonitoresTCP"><span class="nav-icon"></span> TCP IP </a></li>
				<!--
				<li class="nav-item"><a class="nav-link" href="?pagina=MonitoresSQL"><span class="nav-icon"></span> MsSQL </a></li>
				->
			  </ul>
			</li>
		';
...
$templateContent -> setmenuHTML( $contenido );
